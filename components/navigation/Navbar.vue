    ...
    <nav
      ...
      <div class="flex flex-wrap justify-between items-center">
        <div class="flex justify-start items-center">
          ...
          <NuxtLink :to="isLoggedIn ? '/' : '/login'" class="flex items-center justify-between mr-4">
            <img src="public/logo.png" class="mr-3 h-8" alt="Flowbite Logo" />
            <!-- <span class="hidden md:block self-center text-xl font-semibold whitespace-nowrap dark:text-white">
              Fournitures </span> -->
          </NuxtLink>
        </div>
